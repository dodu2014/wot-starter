  ...
  <view class="min-h-screen py-3">
    ...
    <view class="mx-3 mb-3">
      <view class="rounded-3 px-5 py-8 text-center wot-bg-filled-oppo">
        ...
        <view class="mb-2 text-6 font-bold wot-text-text-main"> 全局反馈组件 </view>
        ...
        <view class="text-3 wot-text-text-secondary">
          统一的用户反馈交互体验，支持在路由导航守卫和网络请求拦截器中使用，扩展 WotUI
          交互组件能力。
        </view>
      </view>
      ...
      <demo-block title="GlobalToast 轻提示" transparent>
        <view class="space-y-4">
          ...
          <view class="rounded-2 p-4 wot-bg-filled-oppo">
            <view class="mb-3 text-4 font-bold wot-text-text-main"> 基础用法 </view>
            <view class="grid grid-cols-2 mb-3 gap-2">
              <wd-button type="success" @click="demoToastSuccess"> 成功提示 </wd-button>
              <wd-button type="danger" @click="demoToastError"> 错误提示 </wd-button>
              <wd-button type="warning" @click="demoToastWarning"> 警告提示 </wd-button>
              <wd-button type="info" @click="demoToastInfo"> 信息提示 </wd-button>
            </view>
            ...
            <view class="rounded p-3" @click="copyCode(codeExamples.basicToast)">
              ...
              >
                const { success, error, warning, info } = useGlobalToast() success({ msg:
                '操作成功！' }) error({ msg: '操作失败！' })
              </view>
            </view>
          </view>
          ...
          <!-- 自定义用法 -->
          <view class="rounded-2 p-4 wot-bg-filled-oppo">
            <view class="mb-3 text-4 font-bold wot-text-text-main"> 自定义配置 </view>
            <view class="mb-3">
              <wd-input v-model="customMessage" placeholder="请输入自定义消息" />
            </view>
            <view class="grid grid-cols-2 mb-3 gap-2">
              <wd-button type="primary" @click="demoCustomToast"> 自定义消息 </wd-button>
              <wd-button type="success" @click="demoToastPosition('top')"> 顶部显示 </wd-button>
              <wd-button type="warning" @click="demoToastPosition('middle')"> 中间显示 </wd-button>
              <wd-button type="info" @click="demoToastPosition('bottom')"> 底部显示 </wd-button>
            </view>
      ...
      <demo-block title="GlobalLoading 加载提示" transparent>
        <view class="space-y-4">
          ...
          <view class="rounded-2 p-4 wot-bg-filled-oppo">
            <view class="mb-3 text-4 font-bold wot-text-text-main"> 基础用法 </view>
            <view class="grid grid-cols-2 mb-3 gap-2">
              <wd-button type="primary" @click="demoBasicLoading"> 显示加载(3秒) </wd-button>
              <wd-button type="warning" @click="closeLoading"> 手动关闭 </wd-button>
              <wd-button type="success" @click="demoLoadingNoCover"> 无遮罩加载 </wd-button>
              <wd-button type="info" @click="demoComplex"> 组合演示 </wd-button>
            </view>
        ...
        <view class="space-y-4">
          ...
          <view class="rounded-2 p-4 wot-bg-filled-oppo">
            ...
            <view class="grid grid-cols-3 mb-3 gap-2">
              <wd-button type="primary" @click="demoConfirm"> 确认弹窗 </wd-button>
              <wd-button type="warning" @click="demoAlert"> 警告弹窗 </wd-button>
              <wd-button type="success" @click="demoPrompt"> 输入弹窗 </wd-button>
            </view>
        ...
        <view class="space-y-3">
          <view class="rounded-2 p-4 wot-bg-filled-oppo">
            <view class="mb-3 flex items-center">
              ...
              <view class="text-4 font-bold wot-text-text-main"> 设计理念 </view>
            </view>
            <view class="text-3 leading-relaxed wot-text-text-secondary space-y-2">
              ...
              <view>
                • <text class="text-green-600 font-bold dark:text-green-400"> 状态管理 </text>：基于
                Pinia 管理组件状态，响应式更新
              </view>
              <view>
                •
          ...
          <view class="rounded-2 p-4 wot-bg-filled-oppo">
            <view class="mb-3 flex items-center">
              <view class="mr-2 text-6"> ⚡ </view>
              <view class="text-4 font-bold wot-text-text-main"> 使用优势 </view>
            </view>
            <view class="text-3 leading-relaxed wot-text-text-secondary space-y-2">
              <view>• 统一的用户反馈体验</view>
          ...
          <view class="rounded-2 p-4 wot-bg-filled-oppo">
            <view class="mb-3 flex items-center">
              <view class="mr-2 text-6"> 📝 </view>
              <view class="text-4 font-bold wot-text-text-main"> 最佳实践 </view>
            </view>
            <view class="text-3 leading-relaxed wot-text-text-secondary space-y-2">
